...
import grondag.wit.ux.client.AbstractSimpleContainerScreen;
import grondag.wit.ux.client.GuiUtil;
import grondag.wit.ux.client.ScreenRenderContext;
import grondag.wit.ux.client.control.Button;
import grondag.wit.ux.client.control.ItemStackPicker;
import grondag.wit.ux.client.control.TextField;
...
public class ItemStorageScreen extends AbstractSimpleContainerScreen<WitBaseContainerMenu<DiscreteStorageServerDelegate>> implements ScreenRenderContext {
	...
	public ItemStorageScreen(WitBaseContainerMenu<DiscreteStorageServerDelegate> container, Inventory inventory, Component title) {
		...
		super(container, inventory, Component.translatable("Wit Storage"));
	}
	...
	protected void computeScreenBounds() {
		...
		if (WitConfig.shiftScreensLeftIfReiPresent && FabricLoader.getInstance().isModLoaded("roughlyenoughitems")) {
