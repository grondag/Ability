...
public abstract class Textures {
	...
	public static final TextureSet CRATE_BASE = TextureSet.builder()
			.displayNameToken("crate_base").baseTextureName("wit:block/crate_base")
	...
	public static final TextureSet OPEN_BOX = TextureSetHelper.addDecal(Wit.MODID, "open_box", "open_box", ROTATE_RANDOM);
	public static final TextureSet FILLED_BOX = TextureSetHelper.addDecal(Wit.MODID, "filled_box", "filled_box", ROTATE_RANDOM);
	public static final TextureSet BIN_FACE = TextureSetHelper.addDecal(Wit.MODID, "bin_face", "bin_face", IDENTITY);
	public static final TextureSet HALF_DIVIDER = TextureSetHelper.addDecal(Wit.MODID, "half_divider", "half_divider", STONE_LIKE);
	public static final TextureSet QUARTER_DIVIDER = TextureSetHelper.addDecal(Wit.MODID, "quarter_divider", "quarter_divider", STONE_LIKE);
