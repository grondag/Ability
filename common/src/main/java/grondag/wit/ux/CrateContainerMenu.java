...
import grondag.wit.storage.StorageBlockEntity;
import grondag.wit.storage.item.CrateBlockEntity;

public class CrateContainerMenu extends WitBaseContainerMenu<DiscreteStorageServerDelegate> {
	public static ResourceLocation ID = Wit.id("crate");
