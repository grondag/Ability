...
package grondag.wit.ux.client.color;
...
import grondag.wit.ux.client.color.Color.HCLMode;
...
public class ColorAtlas {
	...
	public static void writeColorAtlas(File folderName) {
		...
		try {
			...
			Wit.LOG.warn("Unable to output color atlas due to file error:" + e.getMessage());
		}
	}
}
