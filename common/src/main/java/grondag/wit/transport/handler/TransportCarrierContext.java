...
package grondag.wit.transport.handler;
...
public abstract class TransportCarrierContext {
	...
	protected int cooldownTicks = ThreadLocalRandom.current().nextInt(WitConfig.utb1ImporterCooldownTicks);
	...
	public void resetCooldown() {
		cooldownTicks = WitConfig.utb1ImporterCooldownTicks;
	}
